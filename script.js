  ...
  try {
    ...
    responseJson.results.forEach((character) => {
      ...
      card.onclick = () => {
        ...
        characterHeight.innerText = `Altura: ${convertHeight(
          character.height
        )}`;
        ...
        eyeColor.innerText = `Cor dos Olhos: ${convertEyeColor(
          character.eye_color
        )}`;

        const birthYear = document.createElement("span");
        birthYear.className = "character-details";
        birthYear.innerText = `Nascimento: ${convertBithYear(
    ...
    console(error);
    alert("Erro ao carregar Characters");
  }
}
...
async function loadNextPage() {
  ...
  try {
    ...
    console.log(error);
    alert("Erro ao carregar pagina seguinte");
  }
}
